...
export class PasswordChangeModalComponent {
  ...
  private readonly dialogRef: MatDialogRef<PasswordChangeModalComponent> = inject(MatDialogRef<PasswordChangeModalComponent>);
  ...
  confirm() {
    ...
    if (this.form.valid) {
      ...
      this.usersService.updatePassword(this.user.id!, this.form.get('password')?.value).subscribe(response => {
