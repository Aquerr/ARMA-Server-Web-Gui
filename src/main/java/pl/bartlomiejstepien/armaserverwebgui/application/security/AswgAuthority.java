...
public enum AswgAuthority
{
    ...
    MODS_PURGE("MODS_PURGE"),
    CDLC_VIEW("CDLC_VIEW"),
    CDLC_UPDATE("CDLC_UPDATE"),
    ...
    MISSIONS_DOWNLOAD("MISSIONS_DOWNLOAD"),
    MISSIONS_PURGE("MISSIONS_PURGE"),
    ...
    MOD_PRESETS_PURGE("MOD_PRESETS_PURGE"),
    UNSAFE_OVERWRITE_STARTUP_PARAMS("UNSAFE_OVERWRITE_STARTUP_PARAMS"),
    DISCORD_SETTINGS_UPDATE("DISCORD_SETTINGS_UPDATE"),
    STEAM_SETTINGS_UPDATE("STEAM_SETTINGS_UPDATE"),
    JOBS_SETTINGS_UPDATE("JOBS_SETTINGS_UPDATE"),
    EDITOR_SERVER_CONFIG_VIEW("EDITOR_SERVER_CONFIG_VIEW"),
    EDITOR_SERVER_CONFIG_SAVE("EDITOR_SERVER_CONFIG_SAVE"),
    EDITOR_NETWORK_CONFIG_VIEW("EDITOR_NETWORK_CONFIG_VIEW"),
    EDITOR_NETWORK_CONFIG_SAVE("EDITOR_NETWORK_CONFIG_SAVE")
