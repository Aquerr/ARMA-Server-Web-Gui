...
import pl.bartlomiejstepien.armaserverwebgui.application.security.authorize.annotation.HasPermissionDiscordSettingsUpdate;
...
public class DiscordSettingsController
{
    ...
    @GetMapping
    @HasPermissionDiscordSettingsUpdate
